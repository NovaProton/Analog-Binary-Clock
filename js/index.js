window.onload = function () {
  ...
  function drawface() {
    ...
    for (r = 1; r <= 6; r++) {
      ...
      for (i = 0; i < 60; i++) {
        ...
        if (i % v === 0) {
          cf$.fillStyle = cf$.fillStyle === firstColor ? secondColor : firstColor;
        }

        cf$.beginPath();
        cf$.arc(cf$.canvas.width / 2 + Math.cos(currentAngle) * (clockRadius - r * clockRadius / 15), cf$.canvas.height / 2 + Math.sin(currentAngle) * (clockRadius - r * clockRadius / 15), clockRadius / 40, 0, Math.PI * 2);
        cf$.fill();
      }
    }
    ...
    for (r = 1; r <= 4; r++) {
      ...
      for (i = 0; i < 12; i++) {
        ...
        cf$.beginPath();
        cf$.arc(cf$.canvas.width / 2 + Math.cos(currentAngle) * (clockRadius / 1.8 - r * clockRadius / 11), cf$.canvas.height / 2 + Math.sin(currentAngle) * (clockRadius / 1.8 - r * clockRadius / 11), clockRadius / 27, 0, Math.PI * 2);
        cf$.fill();
      }
    }
  }
  ...
  function drawHands() {
    ...
    ch$.fillRect(-handsWidth / 2, -handsWidth / 2, handsWidth, -clockRadius + clockRadius / 15);
    ch$.fill();
    ch$.restore();
    ...
    ch$.fillRect(-handsWidth / 2, -handsWidth / 2, handsWidth, -clockRadius + clockRadius / 5);
    ch$.fill();
    ch$.restore();
    ...
    ch$.fillRect(-handsWidth / 2, -handsWidth / 2, handsWidth, -clockRadius + clockRadius / 1.5);
    ch$.fill();
    ch$.restore();

    ch$.beginPath();
    ch$.arc(ch$.canvas.width / 2, ch$.canvas.height / 2, clockRadius / 1.87, 0, Math.PI * 2);
    ch$.stroke();

    ch$.beginPath();
    ch$.arc(ch$.canvas.width / 2, ch$.canvas.height / 2, clockRadius, 0, Math.PI * 2);
    ch$.stroke();

    ch$.beginPath();
    ch$.arc(ch$.canvas.width / 2, ch$.canvas.height / 2, clockRadius / 30, 0, Math.PI * 2);
    ch$.fill();

    ch$.fillStyle = background;
    ch$.beginPath();
    ch$.arc(ch$.canvas.width / 2, ch$.canvas.height / 2, clockRadius / 33, 0, Math.PI * 2);
    ch$.fill();
  }
